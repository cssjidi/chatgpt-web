...
console.log(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 ---- undefined undefined)
console.log(process.env.OPENAI_API_KEY, '----', process.env.MONGODB_URL, process.env.OPENAI_ACCESS_TOKEN)
